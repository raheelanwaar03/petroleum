...
<head>
    ...
    <link href="{{ asset('assets/public/assets/vendor/owl-carousel/owl.carousel.css') }}" rel="stylesheet"
        type="text/css" />

    <link href="{{ asset('assets/public/assets/vendor/nouislider/nouislider.min.css') }}" rel="stylesheet"
        type="text/css" />
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('assets/public/assets/images/avatar/1.jpg') }}"
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('assets/public/assets/images/avatar/2.jpg') }}"
                                                    class="rounded-circle user_img" alt="" />
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('assets/public/assets/images/avatar/3.jpg') }}"
                                                    class="rounded-circle user_img" alt="" />
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('assets/public/assets/images/avatar/4.jpg') }}"
                                                    class="rounded-circle user_img" alt="" />
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('assets/public/assets/images/avatar/5.jpg') }}"
                                                    class="rounded-circle user_img" alt="" />
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                                ...
                                                <div class="timeline-panel">
                                                    <div class="media me-2">
                                                        <img alt="image" width="50"
                                                            src="{{ asset('assets/public/assets/images/avatar/1.jpg') }}">
                                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="mt-4 text-center">
                                                    <h4 class="fs-20 font-w700">Workload Dashboard For CMS Websites
                                                    </h4>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-xl-6 col-12">
                                                <h4 class="fs-24 font-w700 text-white">Manage your project in one
                                                    touch</h4>
                                                <span class="fs-16 text-white d-block">Let Wokrload manage your
                                                    project automatically with our best AI systems </span>
                                            </div>
                                            <div class="col-xl-6 col-12 text-end">
                                                <a href="javascript:void(0);"
                                                    class="btn  bg-white fs-18 btn-rounded">Try Free Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-xl-6 text-center">
                                                ...
                                                <a href="javascript:void(0);"
                                                    class="btn btn-outline-primary btn-rounded">Update Progress</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body px-0">
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box active">
                                                    <img src="{{ asset('assets/public/assets/images/profile/small/pic6.jpg') }}"
                                                        alt="">
                                                </div>
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box">
                                                    <img src="{{ asset('assets/public/assets/images/profile/small/pic7.jpg') }}"
                                                        alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box active">
                                                    <img src="{{ asset('assets/public/assets/images/profile/small/pic4.jpg') }}"
                                                        alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box active">
                                                    <img src="{{ asset('assets/public/assets/images/profile/small/pic3.jpg') }}"
                                                        alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box active">
                                                    <img src="{{ asset('assets/public/assets/images/profile/small/pic5.jpg') }}"
                                                        alt="">
                                                </div>
                                                <div class="ms-3 w-100">
