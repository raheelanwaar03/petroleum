                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="veh_name" id="name" placeholder="Vehicle name">
                            </div>
                            <div class="form-group">
                                <label for="number">Number</label>
                                <input type="text" name="number" id="number" placeholder="ABC 1234">
                            </div>
                            <div class="form-group">
                                <label for="model">Model</label>
                                <input type="text" name="model" id="model" placeholder="2010 etc.">
                            </div>
                            <div class="form-group">
                                <label for="province">Province</label>
                                <select name="veh_type" id="type">
